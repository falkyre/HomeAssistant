...
<script type="text/x-red" data-template-name="lifx-set-state">
    ...
    <div class="form-row">
        <label for="node-input-fast"></i> <span data-i18n="lifx-api.label.fast"></span></label>
        <input type="text" id="node-input-fast" data-i18n="[placeholder]lifx-api.placeholder.fast">
    </div>
</script>
